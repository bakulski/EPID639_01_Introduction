---
title: "EPID639 R for Epidemiologic Analysis"
...
Directly after the code chunk will be the output of the code. The code chunk is `print("I'm code")` and the output is "I'm code".
...
The R console is a full calculator. Try to play around with it: + is add, - is subtract, / is divide, * is multiply. ^  is power. Parentheses ( ) work with order of operations, meaning the contents of the inner pair will be calculated first.
